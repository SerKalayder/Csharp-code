...
namespace SimplexMethod_ConsoleApplication
{
    class SimplexTable
    {
        ...
        int colsCount;
        double[][] matrix;
        string[] basisVector; // stores basis var names (Ei)
        string[] nonBasisVector; // stores non-basis var names (Xi)
        ...
        void ReadData()
        {
            ...
            using (StreamReader sr = new StreamReader("input.txt"))
            {
                ...
                colsCount = nonBasisVarsCount + 1;
                rowsCount = basisVarsCount + 1;
