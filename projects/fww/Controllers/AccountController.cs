...
namespace fww.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        public ActionResult AdditionRegInfo()
        {
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AdditionRegInfo(CustomUserInfo model, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                using (CommonContext ctx = new CommonContext())
                {
                    ...
                    var user = (from items in ctx.CustomUserInfos where 
                                   items.UserName == User.Identity.Name select items).Single();
        ...
        public ActionResult RegistrationChecking()
        {
            return View();
        }
